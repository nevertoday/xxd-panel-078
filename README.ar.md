...
# 🦁 XXD Panel 078｜دفتر مطبوع برقائق الذهب

### يضغط محيط الصورة الأساسي داخل ورق قطني عاجي بخطوط ذهب شامبانيا غائرة
...
تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 078 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.
...
يختزل **Panel 078** المحيط والبنية والوضع والعلاقة إلى علامة خطية دقيقة، ثم يضغط ذهب الشامبانيا والضغط الخالي من الحبر بعمق داخل ورق قطني عاجي دافئ. تقع الخطوط داخل أخاديد حقيقية، وتثبت الألياف المضغوطة وضوء الحافة وظل الضغط اتجاهها إلى الداخل.
...
- الحصول على فخامة هادئة من ورق قطني دافئ وذهب شامبانيا داخل الأخدود وضغط ثانوي بلا حبر؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 078 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
|---|---|
| **الناتج** | عمل ذهب شامبانيا غائر يشبه أنظمة العطور والمجوهرات وقرطاسية الأعراس الراقية |
| **البصمة الواضحة** | خطوط ذهب داخل أخاديد حقيقية مع ضغط الورق وضوء الحافة وظل الضغط وألياف القطن |
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-078`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-078-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-078-prompt.zh-CN.md)
...
**البصمة:** ورق قطني عاجي · ضغط غائر عميق · ذهب شامبانيا داخل الأخدود · علامة خطية دقيقة · ضغط بلا حبر · فخامة هادئة
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 078. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-078 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-078 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-078 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-078 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-078 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 078 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-078 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
تم تحديث سلسلة XXD Panel الحالية لتشمل 001–112، ويحتفظ كل Panel بموجّهه الأصلي ومنطقه الجمالي المستقل. الجدول أدناه هو الدليل التاريخي حتى وقت إصدار هذا المشروع؛ يسرد 001–078 بصورة متتابعة، ويظهر المشروع الحالي بخط عريض.
