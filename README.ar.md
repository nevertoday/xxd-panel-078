...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 078 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.
...
```text
استخلاص الهوية والمحيط والبنية والوضع والعلاقة → اختزالها إلى خط دقيق → مركز بصري واحد فوق الورق القطني → ضغط ذهب الشامبانيا عميقًا داخل الأخدود → ضغط بلا حبر كبنية مساندة → ألياف الورق وضوء الحافة وظل الضغط → ضغط النص القليل بالعملية نفسها
```

## سمات النتيجة النهائية

- تقع خطوط الذهب داخل أخاديد غائرة حقيقية ولا ترتفع فوق السطح.
- يظهر ضغط الورق وضوء الحافة الدقيق وظل الضغط الطبيعي وألياف القطن المرئية.
- يعمل قدر قليل من الضغط بلا حبر كبنية ثانية أكثر هدوءًا.
- يبقى مركز بصري واحد محاطًا بفراغ واسع وساكن.
- يُضغط الخط التحريري الرفيع والحديث داخل الورق بالعملية نفسها المستخدمة للرسم.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-078-prompt.en.md)
...
يحافظ كل مشروع من مشاريع Panel الـ78 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 078 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–078) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
